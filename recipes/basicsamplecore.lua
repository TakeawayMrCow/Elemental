basicsamplecoremakeRecipe = {
    type = "recipe",
    name = "basicsamplecoremake",
    ...
    results = {
      { type = "item", name = "basicsamplecore", amount =1, probability = 0.85},
      { type = "item", name = "chert", amount =4, probability = 0.15},
    },
...
data:extend{basicsamplecoremakeRecipe}
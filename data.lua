...
require("technologies.cherttech")

require("technologies.mgprocess")
...
require("recipes.electricdrillimp")

require("recipes.elecdrillFe1")

require("recipes.longinsertimp")

require("recipes.longinsertFe1")

require("recipes.bad-split")
...
require("recipes.PGMslurryref1")

require("recipes.gettingridofpotassium")
...
require("recipes.fluid-dump")

require("items.boron")

require("items.fluoricboronsolution")

require("items.boronsolution")

require("recipes.boronsolution")

require("items.coal-solids")

require("items.coal-slurry")

require("recipes.coalsep")

require("items.coal-gas")

require("items.carbon-distilates")
...
require("recipes.bromicacid")

require("items.bromicacid")
